...
export const FireBrigadeYouth: CollectionConfig = {
  slug: 'fire-brigade-youth',
  labels: {
    singular: {
      en: 'Fire Brigade Youth',
      de: 'Feuerwehrjugend',
    },
    plural: {
      en: 'Fire Brigade Youth',
  ...
  admin: {
    ...
    group: 'Pages',
    description: {
      en: 'Manage the fire brigade youth page heading and team members',
      de: 'Verwalten Sie den Feuerwehrjugend-Seitentitel und die Teammitglieder',
    },
  ...
  hooks: {
      ...
      async ({ operation, req }) => {
        ...
        if (operation === 'create') {
          ...
          if (existing.totalDocs > 0) {
            throw new Error('Only one Fire Brigade Youth record is allowed. Please update the existing record instead.')
          }
        }
      },
    ],
    beforeDelete: [
      async () => {
        ...
        throw new Error('Deletion of Fire Brigade Youth record is not allowed')
      },
    ],
  },
  fields: [
    {
      ...
      admin: {
        ...
        placeholder: {
          en: 'Fire Brigade Youth of FF-Droß',
          de: 'Feuerwehrjugend der FF-Droß',
        },
      },
    },
    {
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          admin: {
            description: {
              en: 'Position/role (e.g., "Youth Leader", "Youth Member")',
              de: 'Position/Rolle (z.B. "Jugendbetreuer", "Jugendmitglied")',
            },
          },
        },
        {

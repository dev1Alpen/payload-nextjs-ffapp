...
export const Kommando: CollectionConfig = {
  slug: 'kommando',
  labels: {
    singular: {
      en: 'Kommando',
  ...
  admin: {
    ...
    group: 'Pages',
    description: {
      en: 'Manage the kommando page heading and team members',
      de: 'Verwalten Sie den Kommando-Seitentitel und die Teammitglieder',
    },
  ...
  hooks: {
      ...
      async ({ operation, req }) => {
        ...
        if (operation === 'create') {
          ...
          if (existing.totalDocs > 0) {
            throw new Error('Only one Kommando record is allowed. Please update the existing record instead.')
          }
        }
      },
    ],
    beforeDelete: [
      async () => {
        ...
        throw new Error('Deletion of Kommando record is not allowed')
      },
    ],
  },
  fields: [
    {
      ...
      admin: {
        ...
        placeholder: {
          en: 'Command of FF-Droß',
          de: 'Kommando der FF-Droß',
        },
      },
    },
    {
      ...
      admin: {
        ...
        placeholder: {
          en: 'We are very proud to have some very active members in our ranks, but we are also very happy to welcome new comrades to our ranks. If you are interested, please contact our commander.',
          de: 'Wir sind sehr stolz darüber einige sehr aktive Mitglieder in unseren Reihen zu haben, doch wir freuen uns auch sehr, wenn wir neue Kameraden in unseren Reihen begrüßen dürfen. Bei Interesse melden Sie sich einfach bei unserem Kommandanten.',
        },
      },
    },
    {

...
export const Reserve: CollectionConfig = {
  slug: 'reserve',
  labels: {
    singular: {
      en: 'Reserve',
  ...
  admin: {
    ...
    group: 'Pages',
    description: {
      en: 'Manage the reserve page heading and team members',
      de: 'Verwalten Sie den Reserve-Seitentitel und die Teammitglieder',
    },
  ...
  hooks: {
      ...
      async ({ operation, req }) => {
        ...
        if (operation === 'create') {
          ...
          if (existing.totalDocs > 0) {
            throw new Error('Only one Reserve record is allowed. Please update the existing record instead.')
          }
        }
      },
    ],
    beforeDelete: [
      async () => {
        ...
        throw new Error('Deletion of Reserve record is not allowed')
      },
    ],
  },
  fields: [
    {
      ...
      admin: {
        ...
        placeholder: {
          en: 'Reserve of FF-Droß',
          de: 'Reserve der FF-Droß',
        },
      },
    },
    {
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          admin: {
            description: {
              en: 'Position/role (e.g., "Reserve Member", "Reserve Leader")',
              de: 'Position/Rolle (z.B. "Reservemitglied", "Reserveführer")',
            },
          },
        },
        {

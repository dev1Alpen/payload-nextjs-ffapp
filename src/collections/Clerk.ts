...
export const Clerk: CollectionConfig = {
  slug: 'clerk',
  labels: {
    singular: {
      en: 'Clerk',
  ...
  hooks: {
    ...
    beforeDelete: [
      async () => {
        ...
        throw new Error('Deletion of Clerk record is not allowed')
      },
    ],
  },
  fields: [
    ...
    },
    {
      ...
      admin: {
        ...
        placeholder: {
          en: 'We are very proud to have some very active members in our ranks, but we are also very happy to welcome new comrades to our ranks. If you are interested, please contact our clerk.',
          de: 'Wir sind sehr stolz darüber einige sehr aktive Mitglieder in unseren Reihen zu haben, doch wir freuen uns auch sehr, wenn wir neue Kameraden in unseren Reihen begrüßen dürfen. Bei Interesse melden Sie sich einfach bei unserem Kanzler.',
        },
      },
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          admin: {
            description: {
              en: 'Position/role (e.g., "Clerk", "Deputy Clerk")',
              de: 'Position/Rolle (z.B. "Kanzler", "Kanzler Stellvertreter")',
            },
          },
        },
        {

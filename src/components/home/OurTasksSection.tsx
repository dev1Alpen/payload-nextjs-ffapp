...
const tasks: Task[] = [
  {
    id: 1,
    title: 'Rescue',
    description: 'Our fire department is ready to rescue people and animals from life-threatening situations.',
    icon: (
  ...
  },
  {
    id: 2,
    title: 'Extinguish',
    description: 'With the most modern equipment, we fight fires quickly and effectively to protect lives and property.',
    icon: (
  ...
  },
  {
    id: 3,
    title: 'Recover',
    description: 'We recover vehicles, objects, and trapped persons in accidents and disaster situations.',
    icon: (
  ...
  },
  {
    id: 4,
    title: 'Protect',
    description: 'Through fire safety watches and preventive measures, we protect the population and environment.',
    icon: (
      <svg className="w-16 h-16" fill="currentColor" viewBox="0 0 640 512" xmlns="http://www.w3.org/2000/svg">
...
export default function OurTasksSection() {
  return (

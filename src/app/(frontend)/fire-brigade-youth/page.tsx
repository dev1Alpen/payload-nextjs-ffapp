...
export default async function FireBrigadeYouthPage({ searchParams }: Props) {
  ...
  // Fetch fire brigade youth page data from CMS
  const pageData = {
  ...
  try {
    ...
    // Fetch the first fire-brigade-youth document (typically there will be only one)
  ...
  return (
    <>
      ...
      <div className="relative bg-gradient-to-b from-gray-50 via-white to-gray-50 pb-16">
        ...
        {/* Fire Brigade Youth Team Section */}
        {youthTeam.length > 0 && (
